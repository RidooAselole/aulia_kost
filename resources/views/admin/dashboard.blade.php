...
<body>
        ...
        <main class="admin-main">
            ...
            <div class="admin-content">
                ...
                <section id="manage-bookings" class="admin-card {{ $section == 'manage-bookings' ? 'section-active' : 'hidden' }}">
                    ...
                    <p>Lihat dan kelola semua booking kamar beserta status pembayaran.</p>
                    <table class="booking-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $booking->payment_due->format('d/m/Y') }}</td>
                                <td>
                                    <div class="action-buttons">
                ...
                <section id="settings" class="admin-card {{ $section == 'settings' ? 'section-active' : 'hidden' }}">
                    <h3>Pengaturan</h3>
                    <form action="#" method="POST" id="settingsForm" onsubmit="event.preventDefault(); alert('Fitur ini akan tersedia setelah database diimplementasikan');">
                        @csrf
    ...
    <script>
        ...
        function editRoom(id, number, price, status, tenant) {
            ...
            document.getElementById('roomTenant').value = tenant || '';
        ...
        function editBooking(id, name, roomNumber, regDate, paymentStatus, paymentDue, notes) {
        ...
        document.querySelector('.btn-primary').addEventListener('click', function(e) {
            if (e.target.textContent.includes('Tambah Kamar Baru')) {
